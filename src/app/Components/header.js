...
const Header = () => (
  <header className="flex justify-between items-center py-6 px-32">
    ...
    <div className="flex items-center space-x-8">
      ...
      <Button className="bg-green-500 hover:bg-green-600bg-green-500 text-white px-6 py-2 rounded-md hover:bg-green-600">
  ...
  >
    <div className="flex items-center justify-between pl-44">
      ...
      <div className="relative pt-12 pr-44">
        <img
          src={`/Images/Illustration${isActive ? "active" : "inactive"}.png`}
          alt="Illustration"
          className="w-96"
        />
      </div>
...
const Hero = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      subtitle: "Discover new techniques to enhance your photography skills",
    },
    {
      title: "Build a thriving online presence",
      subtitle:
        "Learn how to leverage digital platforms for your photography business",
    },
  ];
